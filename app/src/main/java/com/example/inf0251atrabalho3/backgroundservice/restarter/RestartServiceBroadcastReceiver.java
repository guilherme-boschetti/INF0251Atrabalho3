package com.example.inf0251atrabalho3.backgroundservice.restarter;
...
public class RestartServiceBroadcastReceiver extends BroadcastReceiver {
    ...
    public static final String TAG = "INF-BroadcastReceiver";
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        SharedPreferencesUtil preferences = SharedPreferencesUtil.getInstance(context);
